...
class TensorflowDownloadModelTasks : Plugin<Project> {
    override fun apply(project: Project) {
        val assetDir = "${project.projectDir}/src/main/assets/tensorflow"
        val testAssetDir = "${project.projectDir}/src/androidTest/assets/tensorflow"
        val urlPath = "https://storage.googleapis.com/download.tensorflow.org/models/tflite/task_library/object_detection/android"
